...
GITHUB CI: pending implementation publication; status remains IMPLEMENTED_CI_BROWSER_QA_PENDING until the new commit has real Consumer QA evidence. Required screenshots: `apps/web/qa-evidence/pass-12/person-390.png`, `person-834.png`, `person-1536.png`. Fixtures are synthetic QA data only. Manual screenshot review is not pixel-baseline comparison.
